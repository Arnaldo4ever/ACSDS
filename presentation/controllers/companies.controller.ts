...
import {
  ResponseError,
  ResponseErrorCode,
} from "../response-entities/response-error.js";
...
export class CompaniesController {
  ...
  public async getPaymentTerms(req: Request, res: Response) {
  ...
  /**@deprecated */
  public async changePaymentTermsLegacy(req: Request, res: Response) {
  ...
  public async changePaymentTerms(req: Request, res: Response) {
    logger.debug('companiesController: Changing Company Payment Terms');
    const body = req.body;
    logger.debug(body);
    const customer_token = req.header('Usertoken');
  ...
  public async getCompanyBillingAddress(req: Request, res: Response) {
    const body = req.body;
  ...
  public static async getERPPartners(req: Request, res: Response) {
    try {
      const { limit = 10, offset = 0 } = req.query;

      const partners = await this.erpService.getPartners(
        ['id', 'name', 'email', 'phone', 'street', 'city', 'country_id', 'vat'],
        [],
  ...
  public static async getERPPartnerById(req: Request, res: Response) {
    try {
      const { id } = req.params;
