...
export class CustomersController {
  ...
  public async updateLastVisit(req: Request, res: Response) {
    logger.debug(req.query);
    try {
      const customer_id = req.query.logged_in_customer_id as string | undefined;
      ...
      const updateStatus = await metafieldsService.metafieldsSet([new MetafieldSetInput('last_visit', 
        'upng', 
