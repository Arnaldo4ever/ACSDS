...
export const validateAppProxySignature = async (req, res, next) => {
    ...
    const query_hmac = createHmac('sha256', process.env.SHOPIFY_API_SECRET).update(queryString).digest('hex');
