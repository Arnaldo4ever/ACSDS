 ...
 */
export const validateAdminRequest = async (req, res, next) => {
    try {
        const session_bearer = req.header("authorization");
        if (!session_bearer) {
            logger.error("No se ha encontrado header de autenticación, seguro que esta ruta es autenticada?");
